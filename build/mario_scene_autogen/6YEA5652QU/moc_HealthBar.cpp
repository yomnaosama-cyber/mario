...
namespace {
struct qt_meta_stringdata_HealthBar_t {
    uint offsetsAndSizes[2];
    char stringdata0[10];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_HealthBar_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_HealthBar_t qt_meta_stringdata_HealthBar = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_HealthBar[] = {
...
Q_CONSTINIT const QMetaObject HealthBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_HealthBar.offsetsAndSizes,
    qt_meta_data_HealthBar,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_HealthBar_t,
        // Q_OBJECT / Q_GADGET
...
void *HealthBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HealthBar.stringdata0))
